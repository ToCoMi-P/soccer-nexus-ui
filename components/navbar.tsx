import { Navbar as NextUINavbar, NavbarContent, NavbarItem, NavbarMenu, NavbarMenuItem, NavbarMenuToggle } from "@nextui-org/navbar";
...
import { GithubIcon, PayPalFilledIcon, SearchIcon } from "@/components/icons";
        ...
        <div className="mx-4 mt-2 gap-2">
          {siteConfig.navMenuItems.map((item, index) => (
            <NavbarMenuItem key={`${item}-${index}`}>
              <NextLink href={item.href} color={index === 2 ? "primary" : index === siteConfig.navMenuItems.length - 1 ? "danger" : "foreground"}>
                {item.label}
              </NextLink>
              {/*<Link
								color={
